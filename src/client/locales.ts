...
export const zh = {
  ...
  'notify.body.question': '「{title}」有需要你回答的问题',
  'notify.title.planReview': 'DSH：有份计划等待你批准',
  'notify.body.planReview': '「{title}」有份计划等待你批准',
  'notify.title.approval': 'DSH：有操作请求等待你批准',
  'notify.body.approval': '「{title}」有操作请求等待你批准',
...
export const en = {
  ...
  'notify.body.question': "'{title}' has a question for you",
  'notify.title.planReview': 'DSH: a plan is waiting for your approval',
  'notify.body.planReview': "'{title}' has a plan waiting for your approval",
  'notify.title.approval': 'DSH: an action is waiting for your approval',
  'notify.body.approval': "'{title}' has an action waiting for your approval",
